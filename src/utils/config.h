...
#ifdef __APPLE__
	#define ABOUT_WINDOW_ICON_PATH ":/assets/macos/mac-icon.png"
#else
	#define ABOUT_WINDOW_ICON_PATH ":/assets/icon.png"
#endif


// cmake definitions
#ifndef TARGET_VERSION_STRING
	#define TARGET_VERSION_STRING "unknown"
#endif
